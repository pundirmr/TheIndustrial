...
function Model(props) {
  ...
  const { nodes } = useGLTF('/machin.glb')
  ...
  return (
    <group ref={group} {...props}>
      <mesh castShadow receiveShadow geometry={nodes.Node_3.geometry} rotation={[0, 0, 0]} scale={0.008} position={[1, 5, 0]} dispose={null}>
        <meshLambertMaterial color="#404044" />
      </mesh>
      <Annotation position={[3.75, 3.5, 1]}>
        Element 1 <span style={{ fontSize: '1.5em' }}>⚙️ </span>
      </Annotation>
      <Annotation position={[-6, 8.2, 0]}>
        Element 2 <span style={{ fontSize: '1.5em' }}>⚙️ </span>
      </Annotation>
      <Annotation position={[3, 8.2, 0.2]}>
        <span style={{ fontSize: '1.5em' }}>🔧</span> Element 3
      </Annotation>
